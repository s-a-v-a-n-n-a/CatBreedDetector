...
class CatBreedDataset(Dataset):
    ...
    def from_data_path(
        ...
        df, labels = CatBreedDataset.get_dataframe_from_dir(data_dirs, num_labels)
        result = cls(
            CatBreedDataset.get_dataset_from_dataframe(df, labels, randomize, seed),
            processor,
            transform,
        )
        result.df = df
    ...
    def get_dataset_from_dataframe(df, labels_list, randomize: bool, seed: int):
        ...
        if randomize:
            ...
            for _, chunk in enumerate(chunks):
                processed_chunk = CatBreedDataset.random_resample(chunk, seed)
